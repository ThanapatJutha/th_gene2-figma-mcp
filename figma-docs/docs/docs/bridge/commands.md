...
| `read-connections` | Read `figma/app/.figma-sync/connections.json` |
| `save-connections` | Write `figma/app/.figma-sync/connections.json` |
| `read-layer-map` | Read `figma/app/.figma-sync/layer-map.json` — maps sub-components to Figma layers |
...
| `bridge_read_connections` | `read-connections` | Read Code Connect links from `figma/app/.figma-sync/connections.json` |
...
| `bridge_read_layer_map` | `read-layer-map` | Read layer map from `figma/app/.figma-sync/layer-map.json` |
