      ...
      {status === 'disconnected' && (
        <div className={styles.emptyState}>
          ...
          <ol className={styles.steps}>
            <li>Run <code>npx gene2-figma-mcp bridge</code> in your terminal</li>
        ...
        >
          ...
          {configLoaded && !hasConfig && (
            <div className={styles.emptyState}>
              ...
              <ol className={styles.steps}>
                <li>Go to <a href="/ui/settings"><strong>⚙️ Settings</strong></a></li>
              ...
              <a href="/ui/settings" className={styles.btnPrimary} style={{ display: 'inline-block', marginTop: 12, textDecoration: 'none' }}>
                Go to Settings →
              </a>
            </div>
          )}
              ...
              <div className={styles.actionBar}>
                ...
                {projectComponents.length === 0 && (
                  <span className={styles.hint}>
                    ⚠️ No project components discovered. Check your <a href="/ui/settings">include patterns</a>.
                  </span>
                )}
              </div>
                              ...
                              <div className={styles.linkBlock}>
                                ...
                                {projectComponents.length > 0 ? (
                                  ...
                                  <p className={styles.hint}>
                                    <a href="/ui/settings">Configure Settings</a> to discover project components.
                                  </p>
                                )}
                              </div>
                            )}
