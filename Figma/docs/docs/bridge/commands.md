...
| Command | Purpose |
|---|---|
| `read-config` | Read `Figma/config/figma.config.json` |
| `save-config` | Write `Figma/config/figma.config.json` |
...
| `read-connections` | Read `Figma/config/.figma-sync/connections.json` |
| `save-connections` | Write `Figma/config/.figma-sync/connections.json` |
| `read-layer-map` | Read `Figma/config/.figma-sync/layer-map.json` — maps sub-components to Figma layers |
...
| MCP Tool | Bridge Command | Description |
|---|---|---|
| `bridge_read_config` | `read-config` | Read `Figma/config/figma.config.json` project configuration |
| `bridge_read_connections` | `read-connections` | Read Code Connect links from `Figma/config/.figma-sync/connections.json` |
...
| `bridge_read_layer_map` | `read-layer-map` | Read layer map from `Figma/config/.figma-sync/layer-map.json` |
