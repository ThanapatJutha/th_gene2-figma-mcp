...
| Command | Purpose |
|---|---|
| `read-config` | Read `figma/app/figma.config.json` |
| `save-config` | Write `figma/app/figma.config.json` |
...
| MCP Tool | Bridge Command | Description |
|---|---|---|
| `bridge_read_config` | `read-config` | Read `figma/app/figma.config.json` project configuration |
